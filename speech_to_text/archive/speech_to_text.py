...
# function to clean up before recording
...
# function to process audio into chunks
...
# function to transcribe audio from speech segments
...
def record_audio():
    ...
    try:
        while True:
            ...
            threading.Thread(target=speech_to_text, args=(output_filename,)).start()
